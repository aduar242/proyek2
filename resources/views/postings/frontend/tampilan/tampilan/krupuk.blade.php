			    	...
			    	<div class="row align-items-center justify-content-between d-flex">
						...
						<nav id="nav-menu-container">
							<ul class="nav-menu sf-js-enabled sf-arrows" style="touch-action: auto;">
							  <li class="menu-active"><a href="{{route('frontend.kegiatan')}}">KEGIATAN</a></li>
							  <li class=""><a href="{{route('frontend.krupuk')}}">PRODUK</a></li>
							  <li class=""><a href="{{route('frontend.perusahaan')}}">PD. Sri Tanjung</a></li>
							</ul>
